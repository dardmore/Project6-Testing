...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        it('urls are defined', function() {
            var urlCheck;
            for(urlCheck in allFeeds){
                expect(allFeeds[urlCheck].url.length).not.toBe(0);
            }
        });
        ...
        it('names are defined', function() {
            var nameCheck;
            for(nameCheck in allFeeds){
                expect(allFeeds[nameCheck].url.length).not.toBe(0);
            }
        });
    ...
    describe('Initial Entries', function() {
      ...
      /*  feedEntry = $('.feed .entry');
        ...
        it('will contain at least a single entry in the .feed container upon load', function() {
    ...
    */    
    ...
    describe('New Feed Selection', function() {
         ...
         */
        var currentFeed = $('.header-title').text();
